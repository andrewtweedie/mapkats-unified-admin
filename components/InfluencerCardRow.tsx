...
const InfluencerCardRow: React.FC<InfluencerCardRowProps> = ({ title, influencers }) => {
    ...
    <section className="space-y-6">
      ...
      <div className="flex gap-6 overflow-x-auto pb-6 scrollbar-hide -mx-2 px-2">
        {influencers.map((inf, idx) => (
          <div 
            key={idx} 
            className="min-w-[280px] max-w-[280px] bg-white rounded-2xl shadow-soft border border-gray-100 flex flex-col group hover:shadow-panel transition-all hover:-translate-y-1 overflow-hidden"
          >
            {/* Image Section */}
            ...
            <div className="p-5 flex flex-col flex-1">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  <button className="text-blue-500 hover:scale-110 transition-transform"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg></button>
              ...
              <div className="mt-4 pt-4 border-t border-gray-50">
                <button className="w-full bg-brand-dark text-white text-[11px] font-bold tracking-widest py-3 rounded-xl transition-all hover:bg-brand-accent shadow-md">
                  VIEW PROFILE
                </button>
              </div>
            </div>
